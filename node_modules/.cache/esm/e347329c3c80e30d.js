let express,mongoose,cors,socket,fs,path,nodemailer,PORT,MONGODB_URL,SERVER_Path,errorHandler,router,getCurrentUser,userDisconnect,joinUser,getCurrentRoom,checkRoom,totalOnlineUsers,Message;_3c8‍.w("express",[["default",["express"],function(v){express=v}]]);_3c8‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_3c8‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_3c8‍.w("socket.io",[["default",["socket"],function(v){socket=v}]]);_3c8‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_3c8‍.w("path",[["default",["path"],function(v){path=v}]]);_3c8‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_3c8‍.w("./config",[["PORT",["PORT"],function(v){PORT=v}],["MONGODB_URL",["MONGODB_URL"],function(v){MONGODB_URL=v}],["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);_3c8‍.w("./errorHandler",[["errorHandler",["errorHandler"],function(v){errorHandler=v}]]);_3c8‍.w("./routers",[["default",["router"],function(v){router=v}]]);_3c8‍.w("./socketUsers",[["getCurrentUser",["getCurrentUser"],function(v){getCurrentUser=v}],["userDisconnect",["userDisconnect"],function(v){userDisconnect=v}],["joinUser",["joinUser"],function(v){joinUser=v}],["getCurrentRoom",["getCurrentRoom"],function(v){getCurrentRoom=v}],["checkRoom",["checkRoom"],function(v){checkRoom=v}],["totalOnlineUsers",["totalOnlineUsers"],function(v){totalOnlineUsers=v}]]);_3c8‍.w("./models/message",[["default",["Message"],function(v){Message=v}]]);
...
db.on('error', _3c8‍.g.console.error.bind(_3c8‍.g.console, 'connection error:'));
db.once('open', () => {
...
io.on("connection", (socket) => {
  ...
  socket.on("joinChat", ({sender, _id}) => {
    ...
    _3c8‍.g.console.log(socket.id, "=id");
  ...
  socket.on("chat", async (value) => {
    ...
    _3c8‍.g.console.log(value.text,'socket');
    ...
    _3c8‍.g.console.log(empty, 'checkfdkljasd');
  ...
  socket.on("disconnect", () => {
    ...
    _3c8‍.g.console.log(dUser, 'disconnect');
    if(dUser){
