let express,mongoose,cors,socket,fs,path,nodemailer,PORT,MONGODB_URL,SERVER_Path,errorHandler,router,getCurrentUser,userDisconnect,joinUser,getCurrentRoom,checkRoom,totalOnlineUsers,Message;_26f‍.w("express",[["default",["express"],function(v){express=v}]]);_26f‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_26f‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_26f‍.w("socket.io",[["default",["socket"],function(v){socket=v}]]);_26f‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_26f‍.w("path",[["default",["path"],function(v){path=v}]]);_26f‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_26f‍.w("./config",[["PORT",["PORT"],function(v){PORT=v}],["MONGODB_URL",["MONGODB_URL"],function(v){MONGODB_URL=v}],["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);_26f‍.w("./errorHandler",[["errorHandler",["errorHandler"],function(v){errorHandler=v}]]);_26f‍.w("./routers",[["default",["router"],function(v){router=v}]]);_26f‍.w("./socketUsers",[["getCurrentUser",["getCurrentUser"],function(v){getCurrentUser=v}],["userDisconnect",["userDisconnect"],function(v){userDisconnect=v}],["joinUser",["joinUser"],function(v){joinUser=v}],["getCurrentRoom",["getCurrentRoom"],function(v){getCurrentRoom=v}],["checkRoom",["checkRoom"],function(v){checkRoom=v}],["totalOnlineUsers",["totalOnlineUsers"],function(v){totalOnlineUsers=v}]]);_26f‍.w("./models/message",[["default",["Message"],function(v){Message=v}]]);
...
db.on('error', _26f‍.g.console.error.bind(_26f‍.g.console, 'connection error:'));
db.once('open', () => {
...
io.on("connection", (socket) => {
  ...
  socket.on("joinChat", ({sender, _id}) => {
    ...
    _26f‍.g.console.log(socket.id, "=id");
  ...
  socket.on("chat", async (value) => {
    ...
    _26f‍.g.console.log(value.text,'socket');
    ...
    _26f‍.g.console.log(empty, 'checkfdkljasd');
  ...
  socket.on("disconnect", () => {
    ...
    _26f‍.g.console.log(dUser, 'disconnect');
    if(dUser){
