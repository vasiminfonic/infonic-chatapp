let jwt,joi,JWTSTRING,OTP_SECRET,customErrorHandler,User,fs,UserDto,crypto,verify,nodemailer;_aa9‍.x([["default",()=>_aa9‍.o]]);_aa9‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_aa9‍.w("joi",[["default",["joi"],function(v){joi=v}]]);_aa9‍.w("../../config",[["JWTSTRING",["JWTSTRING"],function(v){JWTSTRING=v}],["OTP_SECRET",["OTP_SECRET"],function(v){OTP_SECRET=v}]]);_aa9‍.w("../../errorHandler",[["customErrorHandler",["customErrorHandler"],function(v){customErrorHandler=v}]]);_aa9‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_aa9‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_aa9‍.w("../../dtos/userDto",[["default",["UserDto"],function(v){UserDto=v}]]);_aa9‍.w("crypto",[["default",["crypto"],function(v){crypto=v}],["verify",["verify"],function(v){verify=v}]]);_aa9‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);
