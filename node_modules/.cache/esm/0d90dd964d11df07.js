let TranslationOrder,customErrorHandler,User,crypto,mongoose,Notification,SERVER_Path,emailService,Message;_4d1‍.x([["default",()=>_4d1‍.o]]);_4d1‍.w("../../models/tralationOrders",[["default",["TranslationOrder"],function(v){TranslationOrder=v}]]);_4d1‍.w("../../errorHandler",[["customErrorHandler",["customErrorHandler"],function(v){customErrorHandler=v}]]);_4d1‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_4d1‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);_4d1‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_4d1‍.w("../../models/notification",[["default",["Notification"],function(v){Notification=v}]]);_4d1‍.w("../../config",[["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);_4d1‍.w("../../services/emailService",[["default",["emailService"],function(v){emailService=v}]]);_4d1‍.w("../../models/message",[["default",["Message"],function(v){Message=v}]]);
  ...
  async addOrder(req, res, next) {
    try {
      ...
      const orderData = {
        ...
        status: order.status,
        ...(order.files.length && {
          files: filesUrl.map((e) => `${SERVER_Path}/${e}</br>`),
        }),
