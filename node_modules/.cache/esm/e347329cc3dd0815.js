let express,mongoose,cors,socket,fs,path,nodemailer,PORT,MONGODB_URL,SERVER_Path,errorHandler,router,getCurrentUser,userDisconnect,joinUser,getCurrentRoom,checkRoom,totalOnlineUsers,Message;_c3d‍.w("express",[["default",["express"],function(v){express=v}]]);_c3d‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_c3d‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_c3d‍.w("socket.io",[["default",["socket"],function(v){socket=v}]]);_c3d‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_c3d‍.w("path",[["default",["path"],function(v){path=v}]]);_c3d‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_c3d‍.w("./config",[["PORT",["PORT"],function(v){PORT=v}],["MONGODB_URL",["MONGODB_URL"],function(v){MONGODB_URL=v}],["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);_c3d‍.w("./errorHandler",[["errorHandler",["errorHandler"],function(v){errorHandler=v}]]);_c3d‍.w("./routers",[["default",["router"],function(v){router=v}]]);_c3d‍.w("./socketUsers",[["getCurrentUser",["getCurrentUser"],function(v){getCurrentUser=v}],["userDisconnect",["userDisconnect"],function(v){userDisconnect=v}],["joinUser",["joinUser"],function(v){joinUser=v}],["getCurrentRoom",["getCurrentRoom"],function(v){getCurrentRoom=v}],["checkRoom",["checkRoom"],function(v){checkRoom=v}],["totalOnlineUsers",["totalOnlineUsers"],function(v){totalOnlineUsers=v}]]);_c3d‍.w("./models/message",[["default",["Message"],function(v){Message=v}]]);
...
db.on('error', _c3d‍.g.console.error.bind(_c3d‍.g.console, 'connection error:'));
db.once('open', () => {
...
io.on("connection", (socket) => {
  ...
  socket.on("joinChat", ({sender, _id}) => {
    ...
    _c3d‍.g.console.log(socket.id, "=id");
  ...
  socket.on("chat", async (value) => {
    ...
    _c3d‍.g.console.log(value.text,'socket');
    ...
    _c3d‍.g.console.log(empty, 'checkfdkljasd');
  ...
  socket.on("disconnect", () => {
    ...
    _c3d‍.g.console.log(dUser, 'disconnect');
    if(dUser){
