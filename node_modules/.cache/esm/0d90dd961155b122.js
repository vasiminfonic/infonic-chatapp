let TranslationOrder,customErrorHandler,User,crypto,mongoose,Notification,SERVER_Path;_115‍.x([["default",()=>_115‍.o]]);_115‍.w("../../models/tralationOrders",[["default",["TranslationOrder"],function(v){TranslationOrder=v}]]);_115‍.w("../../errorHandler",[["customErrorHandler",["customErrorHandler"],function(v){customErrorHandler=v}]]);_115‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_115‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);_115‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_115‍.w("../../models/notification",[["default",["Notification"],function(v){Notification=v}]]);_115‍.w("../../config",[["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);
...
const translationController = {
  async addOrder(req, res, next) {
    try {
      ...
      let admin;
      _115‍.g.console.log(filesUrl, 'FilesUres');
      _115‍.g.console.log(order.files, "FilesOrder");
      _115‍.g.console.log(orderData.files, "FilesOrderMain");
