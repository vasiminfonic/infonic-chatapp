let express,mongoose,cors,socket,fs,path,nodemailer,PORT,MONGODB_URL,SERVER_Path,errorHandler,router,getCurrentUser,userDisconnect,joinUser,getCurrentRoom,checkRoom,totalOnlineUsers,Message;_668‍.w("express",[["default",["express"],function(v){express=v}]]);_668‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_668‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_668‍.w("socket.io",[["default",["socket"],function(v){socket=v}]]);_668‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_668‍.w("path",[["default",["path"],function(v){path=v}]]);_668‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_668‍.w("./config",[["PORT",["PORT"],function(v){PORT=v}],["MONGODB_URL",["MONGODB_URL"],function(v){MONGODB_URL=v}],["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);_668‍.w("./errorHandler",[["errorHandler",["errorHandler"],function(v){errorHandler=v}]]);_668‍.w("./routers",[["default",["router"],function(v){router=v}]]);_668‍.w("./socketUsers",[["getCurrentUser",["getCurrentUser"],function(v){getCurrentUser=v}],["userDisconnect",["userDisconnect"],function(v){userDisconnect=v}],["joinUser",["joinUser"],function(v){joinUser=v}],["getCurrentRoom",["getCurrentRoom"],function(v){getCurrentRoom=v}],["checkRoom",["checkRoom"],function(v){checkRoom=v}],["totalOnlineUsers",["totalOnlineUsers"],function(v){totalOnlineUsers=v}]]);_668‍.w("./models/message",[["default",["Message"],function(v){Message=v}]]);
...
db.on('error', _668‍.g.console.error.bind(_668‍.g.console, 'connection error:'));
db.once('open', () => {
...
io.on("connection", (socket) => {
  ...
  socket.on("joinChat", ({sender, _id}) => {
    ...
    _668‍.g.console.log(socket.id, "=id");
  ...
  socket.on("chat", async (value) => {
    ...
    _668‍.g.console.log(value,'socket');
    ...
    _668‍.g.console.log(empty, 'checkfdkljasd');
  ...
  socket.on("disconnect", () => {
    ...
    _668‍.g.console.log(dUser, 'disconnect');
    if(dUser){
