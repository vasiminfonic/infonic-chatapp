let express,loginController,messageController,orderController,userController,mainOrderController,middle;_e7a‍.x([["default",()=>_e7a‍.o]]);_e7a‍.w("express",[["default",["express"],function(v){express=v}]]);_e7a‍.w("../controllers",[["loginController",["loginController"],function(v){loginController=v}],["messageController",["messageController"],function(v){messageController=v}],["orderController",["orderController"],function(v){orderController=v}],["userController",["userController"],function(v){userController=v}]]);_e7a‍.w("../controllers/mainOrderController",[["default",["mainOrderController"],function(v){mainOrderController=v}]]);_e7a‍.w("../middlewares",[["default",["middle"],function(v){middle=v}]]);
...
router.post('/user/forgot',userController.getFogotUser)
