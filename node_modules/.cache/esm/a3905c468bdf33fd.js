let jwt,joi,JWTSTRING,OTP_SECRET,customErrorHandler,User,fs,UserDto,crypto,verify,nodemailer;_8bd‍.x([["default",()=>_8bd‍.o]]);_8bd‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_8bd‍.w("joi",[["default",["joi"],function(v){joi=v}]]);_8bd‍.w("../../config",[["JWTSTRING",["JWTSTRING"],function(v){JWTSTRING=v}],["OTP_SECRET",["OTP_SECRET"],function(v){OTP_SECRET=v}]]);_8bd‍.w("../../errorHandler",[["customErrorHandler",["customErrorHandler"],function(v){customErrorHandler=v}]]);_8bd‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_8bd‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_8bd‍.w("../../dtos/userDto",[["default",["UserDto"],function(v){UserDto=v}]]);_8bd‍.w("crypto",[["default",["crypto"],function(v){crypto=v}],["verify",["verify"],function(v){verify=v}]]);_8bd‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);
