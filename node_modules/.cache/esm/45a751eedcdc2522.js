let express,loginController,messageController,orderController,userController,assignOrderControll,mainOrderController,NotificationController,translationController,middle,authMiddleware;_dcd‍.x([["default",()=>_dcd‍.o]]);_dcd‍.w("express",[["default",["express"],function(v){express=v}]]);_dcd‍.w("../controllers",[["loginController",["loginController"],function(v){loginController=v}],["messageController",["messageController"],function(v){messageController=v}],["orderController",["orderController"],function(v){orderController=v}],["userController",["userController"],function(v){userController=v}]]);_dcd‍.w("../controllers/assignOrderController/assignOrderController",[["default",["assignOrderControll"],function(v){assignOrderControll=v}]]);_dcd‍.w("../controllers/mainOrderController",[["default",["mainOrderController"],function(v){mainOrderController=v}]]);_dcd‍.w("../controllers/notificationController/notificationController",[["default",["NotificationController"],function(v){NotificationController=v}]]);_dcd‍.w("../controllers/translationController",[["default",["translationController"],function(v){translationController=v}]]);_dcd‍.w("../middlewares",[["default",["middle"],function(v){middle=v}]]);_dcd‍.w("../middlewares/authMiddleware",[["default",["authMiddleware"],function(v){authMiddleware=v}]]);
