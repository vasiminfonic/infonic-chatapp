let express,mongoose,cors,socket,fs,path,nodemailer,PORT,MONGODB_URL,SERVER_Path,errorHandler,router,getCurrentUser,userDisconnect,joinUser,getCurrentRoom,checkRoom,totalOnlineUsers,Message;_05a‍.w("express",[["default",["express"],function(v){express=v}]]);_05a‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_05a‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_05a‍.w("socket.io",[["default",["socket"],function(v){socket=v}]]);_05a‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_05a‍.w("path",[["default",["path"],function(v){path=v}]]);_05a‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_05a‍.w("./config",[["PORT",["PORT"],function(v){PORT=v}],["MONGODB_URL",["MONGODB_URL"],function(v){MONGODB_URL=v}],["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);_05a‍.w("./errorHandler",[["errorHandler",["errorHandler"],function(v){errorHandler=v}]]);_05a‍.w("./routers",[["default",["router"],function(v){router=v}]]);_05a‍.w("./socketUsers",[["getCurrentUser",["getCurrentUser"],function(v){getCurrentUser=v}],["userDisconnect",["userDisconnect"],function(v){userDisconnect=v}],["joinUser",["joinUser"],function(v){joinUser=v}],["getCurrentRoom",["getCurrentRoom"],function(v){getCurrentRoom=v}],["checkRoom",["checkRoom"],function(v){checkRoom=v}],["totalOnlineUsers",["totalOnlineUsers"],function(v){totalOnlineUsers=v}]]);_05a‍.w("./models/message",[["default",["Message"],function(v){Message=v}]]);
...
db.on('error', _05a‍.g.console.error.bind(_05a‍.g.console, 'connection error:'));
db.once('open', () => {
...
io.on("connection", (socket) => {
  ...
  socket.on("joinChat", ({sender, _id}) => {
    ...
    _05a‍.g.console.log(socket.id, "=id");
  ...
  socket.on("chat", async (value) => {
    ...
    _05a‍.g.console.log(value.text,'socket');
    ...
    _05a‍.g.console.log(empty, 'checkfdkljasd');
  ...
  socket.on("disconnect", () => {
    ...
    _05a‍.g.console.log(dUser, 'disconnect');
    if(dUser){
