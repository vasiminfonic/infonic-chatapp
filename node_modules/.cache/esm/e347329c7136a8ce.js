let express,mongoose,cors,socket,fs,path,nodemailer,PORT,MONGODB_URL,SERVER_Path,errorHandler,router,getCurrentUser,userDisconnect,joinUser,getCurrentRoom,checkRoom,totalOnlineUsers,Message;_713‍.w("express",[["default",["express"],function(v){express=v}]]);_713‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_713‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_713‍.w("socket.io",[["default",["socket"],function(v){socket=v}]]);_713‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_713‍.w("path",[["default",["path"],function(v){path=v}]]);_713‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_713‍.w("./config",[["PORT",["PORT"],function(v){PORT=v}],["MONGODB_URL",["MONGODB_URL"],function(v){MONGODB_URL=v}],["SERVER_Path",["SERVER_Path"],function(v){SERVER_Path=v}]]);_713‍.w("./errorHandler",[["errorHandler",["errorHandler"],function(v){errorHandler=v}]]);_713‍.w("./routers",[["default",["router"],function(v){router=v}]]);_713‍.w("./socketUsers",[["getCurrentUser",["getCurrentUser"],function(v){getCurrentUser=v}],["userDisconnect",["userDisconnect"],function(v){userDisconnect=v}],["joinUser",["joinUser"],function(v){joinUser=v}],["getCurrentRoom",["getCurrentRoom"],function(v){getCurrentRoom=v}],["checkRoom",["checkRoom"],function(v){checkRoom=v}],["totalOnlineUsers",["totalOnlineUsers"],function(v){totalOnlineUsers=v}]]);_713‍.w("./models/message",[["default",["Message"],function(v){Message=v}]]);
...
db.on('error', _713‍.g.console.error.bind(_713‍.g.console, 'connection error:'));
db.once('open', () => {
...
io.on("connection", (socket) => {
  ...
  socket.on("joinChat", ({sender, _id}) => {
    ...
    _713‍.g.console.log(socket.id, "=id");
  ...
  socket.on("chat", async (value) => {
    ...
    _713‍.g.console.log(value.text,'socket');
    ...
    _713‍.g.console.log(empty, 'checkfdkljasd');
  ...
  socket.on("disconnect", () => {
    ...
    _713‍.g.console.log(dUser, 'disconnect');
    if(dUser){
